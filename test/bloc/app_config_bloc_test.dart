...
void main(){
    ...
    group("Testing Firebase Remote Config", (){
      ...
      blocTest<AppConfigBloc,AppConfigState>("Testing Debug Option from Firebase Remote Config", 
      build:(){
      ...
      setUp: ()async{
        ...
        when(firebaseRemoteMock.fetchAndActivate()).thenAnswer((_) {
         ...
         when(firebaseRemoteMock.getBool("debug_option_enabled")).thenReturn(true);
      },
      act: ((bloc) {
