...
testWidgets("Page layout testing", (WidgetTester tester) async {
    ...
    // expect(scaffold.backgroundColor,const Color(0xff006606));
    ...
    expect(emailConfirm.style,style);
    ...
    expect(tempText.style, style);

    TextField textField = tester.widget(find.byType(TextField));
    expect(textField.style,style.copyWith(fontSize: 20));
    ...
    expect(textField.decoration?.hintStyle, style.copyWith(fontSize: 20));
