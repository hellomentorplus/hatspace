...
void main() {
  ...
  testWidgets(
    "Test NextButton with DEFAULT-DISABLE-HOVERED",
    (WidgetTester tester) async {
      int count = 0;
      ...
      await tester.wrapAndPump(nextButton);
      ...
      expect(
        reason: "Testing background color of button when disabled",
        btn.style?.backgroundColor?.resolve(disabledState),
        HSColor.neutral3,
      );
    },
  ...
  testWidgets(
    "Test PrevButton with DEFAULT-DISABLE-HOVERED",
    (WidgetTester tester) async {
      int count = 0;
      PrevButton nextButton = PrevButton(
